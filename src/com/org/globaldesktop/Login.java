...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/GlobalCarsLogo.png"))); // NOI18N
    ...
    public void authorise() {
        ...
        if (error.equals("")) {
            try {
                if ("admin".equalsIgnoreCase(username) && (password.equalsIgnoreCase("admin"))) {
                    index i = new index();
                    i.setVisible(true);
                    this.dispose();
                } else {
...
// demoversion();
        authorise();
        JOptionPane.showMessageDialog(rootPane, "Welcome To Global Cars System", "Login", JOptionPane.ERROR_MESSAGE);
