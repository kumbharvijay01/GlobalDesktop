            ...
            if (a == 0) {
                ...
                int i = conn.insert_data("insert into employee_info (employee_name,employee_contactno,employee_dob,employee_address,"
                        ...
                        + "employee_email,employee_status) values (?,?,?,?,?,?,?,?,?,?)", new String[]{jemployee_nametxt.getText(),
                            jemployee_contactnotxt.getText(), jemployee_dobtxt.getText(), jemployee_addresstxt.getText(), jemployee_educationtxt.getText(), jemployee_gender.getSelectedItem().toString(), jemployee_bloodgrp.getSelectedItem().toString(),
